...
import { app, BrowserWindow,BrowserView, Display, Event as ElectronEvent, nativeImage, NativeImage, Rectangle, screen, SegmentedControlSegment, systemPreferences, TouchBar, TouchBarSegmentedControl } from 'electron';
...
import { getMenuBarVisibility, getTitleBarStyle, IFolderToOpen, INativeWindowConfiguration, IWindowSettings, IWorkspaceToOpen, MenuBarVisibility, useWindowControlsOverlay,zoomLevelToZoomFactor } from 'vs/platform/window/common/window';
...
export class CodeWindow extends Disposable implements ICodeWindow {
	...
	constructor(
		...
		//#region create browser window
		{
			...
			const lowcodeWinOptions = { ...options };
